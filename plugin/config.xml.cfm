...
<cfoutput>
	<plugin>
		...
		<displayobjects location="global">
			...
			<displayobject
				name="Bulk Email Form"
				displayobjectfile="extensions/display_objects/bulkEmailForm.cfm" />


			<!--- Configurable Display Object Example --->
			<displayobject
				name="Bulk Email Configurable Display Object"
				component="extensions.contentRenderer"
				displaymethod="dspConfiguredSMTP"
				configuratorJS="extensions/configurators/SMTPsettings/configurator.js"
				configuratorInit="initSMTPsettingsConfigurator"
				persist="false" />
